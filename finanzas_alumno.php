...
$sql = "SELECT concepto, monto, estatus_pago FROM adeudos WHERE matricula = '$matricula'";
$adeudos = $conn->query($sql);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    <title>Finanzas - Portal Alumno</title>
...
<div class="d-flex">
    ...
    <nav class="sidebar p-3" style="width: 250px;">
        ...
        <ul class="nav flex-column gap-2">
            ...
            <li class="nav-item"><a class="nav-link active" href="finanzas_alumno.php"><i class="fa-solid fa-wallet me-2"></i> Finanzas</a></li>
            ...
            <table class="table table-bordered align-middle">
                ...
                <tbody>
                    <?php if ($adeudos && $adeudos->num_rows > 0): ?>
                        <?php while($a = $adeudos->fetch_assoc()): ?>
                        <tr>
                            <td><?php echo htmlspecialchars($a['concepto']); ?></td>
                            <td class="fw-bold">$<?php echo htmlspecialchars($a['monto']); ?></td>
                            <td><span class="badge bg-danger"><?php echo htmlspecialchars($a['estatus_pago']); ?></span></td>
                        </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr><td colspan="3" class="text-center text-success">No tienes adeudos pendientes.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
